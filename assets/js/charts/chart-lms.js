...
! function(NioApp, $) {
    ...
    var courseProgress = {
        labels: ["Desain Multimedia Digital", "Rekayasa Perangkat Lunak", "Basis Data", "Dasar Jaringan Komputer", "Pemrograman Dasar", "Sistem Informasi Manajemen", "Desain Web"],
        stacked: true,
        datasets: [{
            label: "2021",
            color: ["#f98c45", "#6baafe", "#8feac5", "#6b79c8", "#79f1dc", "#FF65B6", "#6A29FF"],
            data: [25, 35, 28, 44, 41, 12, 25, 25] // data: [2500, 2500, 2500, 2500, 2500, 2800]
            ...
            data: [50, 65, 55, 70, 45, 65, 100, 450] // data: [1820, 1820, 1820, 1820, 1820, 1120]
    ...
    var analyticAuData = {
        ...
        datasets: [{
            ...
            color: "#9cabff",
            background: "#9cabff",
            data: [1110, 1220, 1310, 980, 900, 770, 1060, 830, 690, 730, 790, 950, 1100, 800, 1250]
        }]
    };
